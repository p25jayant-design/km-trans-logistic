  ...
  return (
    <Card title="Live KPIs" icon={BarChart3}>
      <div className="mb-3 grid grid-cols-2 gap-2.5">
        ...
        <KpiCard id="avgSystem" icon={Timer} label="Avg Flow Time" value={live.avgSystem} suffix=" min" trend={trends.queueLen} times={trends.times} fullSeries={ks?.avgSystem} fullTimes={fullTimes} color={KPI_COLORS.timeInSystem} onInfoClick={revealDefinition} />
