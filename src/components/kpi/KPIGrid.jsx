  ...
  return (
    <Card title="Live KPIs" icon={BarChart3}>
      <div className="mb-3 grid grid-cols-2 gap-2.5">
        <KpiCard id="avgWait" icon={Clock3} label="Avg Waiting Time" value={live.avgWait} decimals={0} suffix=" min" trend={trends.avgWait} times={trends.times} fullSeries={ks?.avgWait} fullTimes={fullTimes} color={KPI_COLORS.wait} yAxisLabel="Minutes" onInfoClick={revealDefinition} />
        <KpiCard id="queueLen" icon={ListOrdered} label="Queue Length" value={frame.queueLen} trend={trends.queueLen} times={trends.times} fullSeries={ks?.queueLen} fullTimes={fullTimes} color={KPI_COLORS.queue} yAxisLabel="Trucks in Queue" onInfoClick={revealDefinition} />
        <KpiCard id="throughput" icon={TrendingUp} label="Throughput /day" value={live.throughputPerDay} decimals={1} trend={trends.throughputPerDay} times={trends.times} fullSeries={ks?.throughputPerDay} fullTimes={fullTimes} color={KPI_COLORS.throughput} yAxisLabel="Trucks / Day" onInfoClick={revealDefinition} />
        <KpiCard id="busyBays" icon={Wrench} label="Busy Bays" value={busyBays} trend={trends.busyBaysCount} times={trends.times} fullSeries={ks?.busyBays} fullTimes={fullTimes} color={KPI_COLORS.busyBays} yAxisLabel="Bays Busy" onInfoClick={revealDefinition} />
        <KpiCard id="idleBays" icon={CircleSlash} label="Idle Bays" value={idleBays} trend={trends.idleBaysCount} times={trends.times} fullSeries={fullIdleBays} fullTimes={fullTimes} color={KPI_COLORS.idleBays} yAxisLabel="Bays Idle" onInfoClick={revealDefinition} />
        <KpiCard id="workerUtil" icon={Users} label="Worker Utilization" value={avgWorkerUtil * 100} decimals={0} suffix="%" trend={trends.deptUtilAvg} times={trends.times} fullSeries={ks?.deptUtilPct} fullTimes={fullTimes} color={KPI_COLORS.workerUtil} yAxisLabel="% Utilized" onInfoClick={revealDefinition} />
        <KpiCard id="completed" icon={CheckCircle} label="Completed Trucks" value={live.completedCount} trend={trends.completedCount} times={trends.times} fullSeries={ks?.completedCount} fullTimes={fullTimes} color={KPI_COLORS.completed} yAxisLabel="Trucks Completed" onInfoClick={revealDefinition} />
        <KpiCard id="avgSystem" icon={Timer} label="Avg Flow Time" value={live.avgSystem} suffix=" min" trend={trends.avgSystem} times={trends.times} fullSeries={ks?.avgSystem} fullTimes={fullTimes} color={KPI_COLORS.timeInSystem} yAxisLabel="Minutes" onInfoClick={revealDefinition} />
        <KpiCard id="accidentArrivals" icon={AlertTriangle} label="Accident Repair Arrivals" value={accidentLive.arrivalsCount} suffix={` (${accidentArrivalPct.toFixed(0)}%)`} color={KPI_COLORS.accidentArrivals} yAxisLabel="Trucks" onInfoClick={revealDefinition} />
        <KpiCard id="standardArrivals" icon={ClipboardCheck} label="Standard Job Arrivals" value={standardLive.arrivalsCount} suffix={` (${standardArrivalPct.toFixed(0)}%)`} color={KPI_COLORS.standardArrivals} yAxisLabel="Trucks" onInfoClick={revealDefinition} />
      </div>
